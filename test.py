...
df = get_stats(df, '2024-12-5', '2025-1-14', all_hours, all_days, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', light_load, all_days, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', light_load, weekdays, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', light_load, mon_thurs, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', all_hours, fri, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', all_hours, sat, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', all_hours, sun, buy_node, sell_node)
df = get_stats(df, '2024-12-5', '2025-1-14', [6], all_days, buy_node, sell_node)
